/* PrismJS 1.22.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript&plugins=line-numbers+show-language+toolbar+copy-to-clipboard */
var _self =
  ...
  if ("undefined" != typeof self && self.Prism && self.document)
    if (Prism.plugins.toolbar) {
      ...
      Prism.plugins.toolbar.registerButton("copy-to-clipboard", function (t) {
        ...
        ;(e.textContent = "Копировать"), e.setAttribute("type", "button")
        var o = t.element
        ...
        function n() {
          ...
          t.on("success", function () {
            ;(e.textContent = "Скопировано!"), r()
          }),
            t.on("error", function () {
              ;(e.textContent = "Нажмите Ctrl+C чтобы скопировать"), r()
            })
        }
        function r() {
          setTimeout(function () {
            e.textContent = "Копировать"
          }, 5e3)
        }
      })
    } else
