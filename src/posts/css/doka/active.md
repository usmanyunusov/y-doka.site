...
```css
a:active { } /* Селектор по тегу + :active */
.link:active { } /* Селектор по классу + :active */
li .link:focus { } /* Составной селектор + :active */
#id:active { } /* Селектор по тегу + :active */
.link:before:active { } /* Селектор по классу + псевдоэлемент + :active */
```
