...
_[Callback](<https://ru.wikipedia.org/wiki/Callback_(программирование)>)\_ (колбэк, функция обратного вызова) — функция, которая вызывается в ответ на совершение некоторого события.
