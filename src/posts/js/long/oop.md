...
Прочитайте [обзор парадигм программирования](/posts/js/doka/programming-paradigms), чтобы узнать про альтернативные подходы.
...
Классы в JS — это синтаксический сахар над прототипным наследованием. Чтобы в деталях изучить его тонкости работы, советуем прочитать [статью о контексте выполнения в JavaScript](/posts/js/doka/function-context).
