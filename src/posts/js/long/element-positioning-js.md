...
[Как браузер рисует страницы](/posts/js/long/how-the-browser-creates-pages)
...
Старайтесь анимировать свойства `transform` и `opacity`, чтобы сделать сайт или приложение более отзывчивыми. [Как браузер рисует страницы](/posts/js/long/how-the-browser-creates-pages)
