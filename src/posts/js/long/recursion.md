...
- [ ] TODO: Иллюстрация для примера выше.
...
Как мы говорили раньше, цикл и рекурсия похожи, но иногда выгоднее использовать именно рекурсию, и работа с некоторыми структурами данных — именно такой случай.
...
Структуры данных, части которых включают в себя такие же структуры, называются (вы угадали) рекурсивными. Одна из таких структур — это деревья.
...
Если вы работаете с рекурсивной структурой, лучше использовать рекурсию — это будет сильно проще.

</aside>

<aside class="callout">

При работе с рекурсией стоит подумать о кешировании промежуточных результатов, если функция вызывается часто.
