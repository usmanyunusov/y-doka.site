...
- вспомогательные инструменты для клиентских приложений — [системы сборки](/js/tools/bundlers), [распространения пакетов](/js/tools/package-managers), сервера разработки, редакторы кода и [системы статического анализа](/js/tools/static-analysis);
